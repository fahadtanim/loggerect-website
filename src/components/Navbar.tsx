...
export default function Navbar() {
  ...
  const handleNavClick = (section: string) => {
    log.info(`Navigation clicked`, { section });
  };

  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 px-6 py-4 transition-all duration-300 border-b border-white/5 ${
        scrolled ? "bg-[#0a0a0f]/95" : "bg-[#0a0a0f]/80"
      } backdrop-blur-xl`}
    >
